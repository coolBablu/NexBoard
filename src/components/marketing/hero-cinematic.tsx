      ...
      {chips.map((c, i) => (
        ...
        >
          <motion.div
            ...
            className="flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 backdrop-blur-xl shadow-[0_8px_30px_-12px_rgba(139,92,246,0.4)]"
          >
            {c.content}
          </motion.div>
        </motion.div>
