 ...
 *
 * Strictly author-only. Super admins do NOT get a moderation override
 * here — even an admin cannot delete another member's message inside
 * this group. The author is the only "verified" identity that owns
 * the content of a chat bubble.
 */
